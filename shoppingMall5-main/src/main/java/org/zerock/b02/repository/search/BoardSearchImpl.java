...
public class BoardSearchImpl extends QuerydslRepositorySupport implements BoardSearch {
    ...
    @Override
    public Page<BoardAllListDTO> searchWithAll(String[] types, String keyword, Pageable pageable) {
        ...
        List<BoardAllListDTO> dtoList = tupleList.stream().map(tuple -> {
            Board board1 = (Board) tuple.get(board);
            long replyCount = tuple.get(1, Long.class);

            BoardAllListDTO dto = BoardAllListDTO.builder()
                    .bno(board1.getBno())
